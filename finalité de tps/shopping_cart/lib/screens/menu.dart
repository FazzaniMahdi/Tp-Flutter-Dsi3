...
class Menu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GridView.count(
      crossAxisCount: 2, // nb colonnes
      crossAxisSpacing: 10.0, // spacing between items horizontally
      mainAxisSpacing: 30.0, // spacing between items vertically
...
class SelectCard extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return InkWell(
    onTap: () {
      print("inkwell taped"+ choice.title);
    ...
    child: Card(
      ...
      child: Center(child: Column(
        ...
        children: <Widget>[
          ...
          Text(choice.title, style:DefaultTextStyle.of(context).style.apply(fontSizeFactor: 1.6),),
        ]
      ),) 
    ),
    );
